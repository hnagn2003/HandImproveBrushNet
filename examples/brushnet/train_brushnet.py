...
class MyWebDataset():
    ...
    def __call__(self,examples):
        ...
        for example in examples:
            ...
            # print(mask.shape) # W H 1
            # print(type(mask)) # np
            # print(mask.dtype) #uint8
            # print(image.shape) # W H 3
...
def main(args):
    ...
    train_dataset = load_dataset("webdataset", 
                    data_files={"train": os.path.join(args.train_data_dir,"00000.tar")}, 
                    split="train", 
                    streaming=True)
    # for data in train_dataset: #dict_keys(['__key__', '__url__', 'aesthetic_score', 'caption', 'height', 'image', 'original_key', 'segmentation', 'url', 'width'])
    #     print(data['image'])
    #     breakpoint()
    #     exit()
    # exit()
